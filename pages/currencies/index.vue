    ...
    return {
      ...
      meta: [
        ...
        },
        {
          hid: "keywords",
          name: "keywords",
          content: ["Bitcoin", "ビットコイン", "Monacoin", "モナコイン", "BitZeny", "ビットゼニー", "faucet", "蛇口"].join(", ")
        }
      ]
    };
  }
...
export default class extends Vue {
  ...
  public filteredItems(): Faucet[] {
    return this.faucets.filter(w => {
      return this.selectedPayouts.includes(w.payout.name) && this.selectedCurrencies.includes(w.currency.symbol);
    });
  }
